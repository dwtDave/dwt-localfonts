...
namespace DWT\LocalFonts\Vendor\FontLib\Table\Type;

use DWT\LocalFonts\Vendor\FontLib\Table\Table;
use DWT\LocalFonts\Vendor\FontLib\Glyph\Outline;
use DWT\LocalFonts\Vendor\FontLib\Glyph\OutlineSimple;
