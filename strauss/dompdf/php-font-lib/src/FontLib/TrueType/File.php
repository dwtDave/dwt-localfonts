...
namespace DWT\LocalFonts\Vendor\FontLib\TrueType;

use DWT\LocalFonts\Vendor\FontLib\AdobeFontMetrics;
use DWT\LocalFonts\Vendor\FontLib\Font;
use DWT\LocalFonts\Vendor\FontLib\BinaryStream;
use DWT\LocalFonts\Vendor\FontLib\Table\Table;
use DWT\LocalFonts\Vendor\FontLib\Table\DirectoryEntry;
use DWT\LocalFonts\Vendor\FontLib\Table\Type\glyf;
use DWT\LocalFonts\Vendor\FontLib\Table\Type\name;
use DWT\LocalFonts\Vendor\FontLib\Table\Type\nameRecord;
...
class File extends BinaryStream {
  ...
  protected function readTable($tag) {
    ...
    if (!self::$raw) {
      ...
      $class = "DWT\\LocalFonts\\Vendor\\FontLib\\Table\\Type\\$name_canon";
      ...
      $class = "DWT\\LocalFonts\\Vendor\\FontLib\\Table\\Table";
    }
